...
import { Page, Wrapper, ButtonFav } from '../../styles/elements';
import {
  Aside,
  Column,
  MovieHeader,
            ...
            <ColumnsContainer>
              ...
              <Column>
                <MovieHeader>
                  ...
                  <ButtonFav size={30} onClick={() => buttonAction(movie)}>
                    <IconFav>{star}</IconFav>
                  </ButtonFav>
                </MovieHeader>
                <p>{movie['Plot']}</p>
                <p>
...
const mapStateToProps = (state, ownProps) => ({
  ...
  isFavorite:
    state.favorites.findIndex(
      favorite => favorite['imdbID'] === ownProps.match.params.id
    ) >= 0
});

export default connect(
  mapStateToProps,
  { movieGet, addFavorite, removeFavorite }
)(MovieDetail);
